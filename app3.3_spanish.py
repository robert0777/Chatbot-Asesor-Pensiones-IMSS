...
# Initialize NVIDIA AI client using LangChain integration
try:
    llm = ChatNVIDIA(
    ...
    st.error(f"""Failed to initialize NVIDIA client: {str(e)}
             ...
             2. Your account has access to this model
             3. You have installed langchain-nvidia-ai-endpoints package""")
    st.stop()
        ...
        if "documents" in st.session_state:
            try:
                with st.spinner('Analizando documentos...'):
                    ...
                    # Updated to use LangChain integration
                    messages = [
                        {
                            "role": "user",
